  ...
  return (
    <main className="max-w-[1300px] m-auto px-10">
      ...
      >
        ...
        <header className="absolute top-0 left-0 w-[80%] h-20 bg-white z-50 rounded-br-full max-w-[1300px] m-auto flex items-center justify-between pr-20">
          <Link href="/">
            <Image
      ...
      >
        ...
        <div>
          ...
          >
            <Button className="mt-4 rounded-full text-lg group relative bg-[#1a76cb] text-white">
              Plus d'info
          ...
          <div className="grid gap-4 py-4 ">
            {trackingData[0] &&
              trackingData[0].images.split(",").map((n: any, id: any) => {
                const imageUrl = `http://localhost:9001/api/v01/img2/${n.trim()}`;
